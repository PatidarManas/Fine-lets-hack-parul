                    ...
                    <div className="overflow-y-auto py-2 px-3 bg-white flex flex-col justify-between " style={{ height: "81vh" }} >
                        ...
                        <path d="M32,6C17.641,6,6,17.641,6,32c0,14.359,11.641,26,26,26s26-11.641,26-26C58,17.641,46.359,6,32,6z M45.121,28.121l-13,13 C31.535,41.707,30.768,42,30,42s-1.535-0.293-2.121-0.879l-8-8c-1.172-1.171-1.172-3.071,0-4.242c1.172-1.172,3.07-1.172,4.242,0 L30,34.758l10.879-10.879c1.172-1.172,3.07-1.172,4.242,0C46.293,25.05,46.293,26.95,45.121,28.121z"></path>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li>
                                    <a href="../pl" className="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 ">
                                        <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75  group-hover:text-gray-900 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                                            <path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
                                        </svg>
                                        <span className="flex-1 ml-3 text-left whitespace-nowrap">Provide a loan</span>
                                    </a>
                                </li>
                        ...
                        <div class="container  max-w-screen-lg mx-auto">
                            <div>
                                ...
                                <div id='success' class='hidden bg-white rounded-lg shadow-lg py-2 px-4 md:p-4 mb-6'>
                                    ...
                                    <p class="text-gray-500 text-center">Thankyou for your request. </p>
                                ...
                                <div id='form' class="hidden bg-white  rounded-lg shadow-lg p-4 px-4 md:p-8 mb-6 ">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                                        <div class="text-gray-600">
                                            ...
                                            <p class='text-green-400 text-semibold	'>All your personal information are safe
                                                with us and wont be shared with anyone, its only for verification purpose</p>
                                        </div>
                                        ...
                                        <div class="lg:col-span-2">
                                            <p class="mb-2 font-semibold text-sm text-gray-900 ">Upload Document</p>
                                            ...
                                            <button onClick={() => { submithandler() }} class="mt-1 py-2 px-3 bg-blue-500 border rounded-lg text-white" type="submit">Submit</button>
                                ...
                                <div id='pay' class=" hidden w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg mx-auto shadow sm:p-8 ">
                                    <h5 class="mb-4 text-xl font-medium text-gray-500 ">Payment</h5>
