...
const Al = ({user}) => {
    ...
    async function getloans(){
        try {
            await axios.post("http://localhost:4000/transaction/allloans",{
                amountgt:amountval[0]*100000,amountlt:amountval[1]*100000,interestgt:interestval[0],interestlt:interestval[1],timegt:timeval[0],timelt:timeval[1]
            }).then((res)=>{
        ...
        <div className=" bg-blue-100 min-h-screen p-0 m-0" >
            <div className=" bg-blue-100 m-0 p-0  ">
                ...
                <div className='bg-white rounded-lg shadow-lg py-2 px-4 md:p-4 mb-6'>
                        <h2 class="font-semibold text-2xl text-gray-600 text-center">Get Loan</h2>
                    ...
                    <ApplyLoan transaction={transaction}/>
                        )
                    }):""}
